...
<html class="dark">
  ...
  <script defer src="http://127.0.0.1:9002/public/dist/dev/js/vendor_abf132c6.bundle.js"></script><script defer src="http://127.0.0.1:9002/public/dist/dev/js/common_dbb21482.bundle.js"></script><script defer src="http://127.0.0.1:9002/public/dist/dev/js/entry.project-list_4a1eb910.bundle.js"></script></head>
  <body>
    <div id="root">
      <div class="container">
