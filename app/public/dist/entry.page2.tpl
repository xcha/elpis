...
<html lang="zh-CN">
  ...
  <script defer src="http://127.0.0.1:9002/public/dist/dev/js/vendor_add885e7.bundle.js"></script><script defer src="http://127.0.0.1:9002/public/dist/dev/js/common_2a604c0f.bundle.js"></script><script defer src="http://127.0.0.1:9002/public/dist/dev/js/entry.page2_7a92846a.bundle.js"></script></head>
  <body>
    <div id="root"></div>
    <div class="container">
